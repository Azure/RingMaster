...
namespace Microsoft.Azure.Networking.Infrastructure.RingMaster.Server.ZooKeeper
{
    ...
    /// <summary>
    /// Default implementation of <see cref="IZooKeeperServerInstrumentation"/> interface.
    /// </summary>
    public sealed class ZooKeeperServerInstrumentation : IZooKeeperServerInstrumentation
    {
