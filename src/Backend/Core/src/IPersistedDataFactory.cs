...
namespace Microsoft.Azure.Networking.Infrastructure.RingMaster.Backend.Persistence
{
    ...
    public interface IPersistedDataFactory<T>
    {
        ...
        /// <returns>T.</returns>
        T LoadTree(CancellationToken cancellation, out long lastXId);
        ...
        /// <summary>
        /// Creates a change list that will be used to record additions, updates, and removals of persisted data.
        /// </summary>
