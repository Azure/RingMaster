...
namespace Microsoft.Azure.Networking.Infrastructure.RingMaster.Backend.Persistence
{
    ...
    public interface IPersistedData
    {
        ...
        void AppendRead(IChangeList chgs);
        ...
        void AppendCreate(IChangeList chgs);
        ...
        /// <param name="chgs">The CHGS.</param>
        /// <param name="child">The child.</param>
        void AppendAddChild(IChangeList chgs, IPersistedData child);
        ...
        /// <param name="chgs">The CHGS.</param>
        /// <param name="child">The child.</param>
        void AppendRemoveChild(IChangeList chgs, IPersistedData child);
        ...
        void AppendRemove(IChangeList chgs, IPersistedData parent, bool isRecursive = false);

        /// <summary>
        /// Appends the set acl.
        /// </summary>
        /// <param name="chgs">The CHGS.</param>
        void AppendSetAcl(IChangeList chgs);
        ...
        /// <param name="chgs">The changelist.</param>
        void AppendPoison(string spec, IChangeList chgs);
    }
}
